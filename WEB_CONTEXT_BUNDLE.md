...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GUY-A12c"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-v1",
      "problem_contract_sha256": "cc567ead422444c5c3528e153a2c1854137871d3f5103ba565e3ef3a862a7b9c",
      "problem_id": "problem:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47",
      "route_id": "route:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-source-fidelity-01",
      "graph_id": "graph:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist an even Fibonacci pseudoprime?"
          },
          "statement_sha256": "83a3b175751f9c66ad2126043258b364df657c81268fcd69850a537c744d22a9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-root",
      "route_id": "route:um-guy-a12c-even-fibonacci-pseudoprimes-f8502e47-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-guy-a12c-dd1914a8a411",
        "url": "https://www.unsolvedmath.com/problems/GUY-A12c"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
